...
// "firecrawl", not a generic "active-credentials" blob: once the old
// any-Firecrawl-operation proxy is gone, this manager's only remaining job
// is authenticating okf-mcp's own outbound Firecrawl API calls. LLM
