...
pub use driver::{
    CompileOptions, CompileReport, compile, ensure_wiki_schema, list_models, regenerate_index,
    resolve_model_spec, vault_provider_options, vault_provider_options_for_provider,
};
